...
public class LowestCommonAncestorBT {
	...
	public Node getLCA(Node root, Node n1, Node n2) {
		...
		if (root == null) {
			...
			if (left != null) {
				System.out.println("printing left: " + left.data);
				return left;
			} else if (right != null) {
				System.out.println("printing right: " + right.data);
				return right;
			}
			return null;
		}
	...
	public static void main(String[] args) throws java.lang.Exception {
		...
		System.err.println("Lowest Common Ancestor (" + n1.data + ", " + n2.data + " ) is " + x.data);
		// x = i.getLCA(root, n2, n3);
		// System.err.println("Lowest Common Ancestor (" + n2.data + ", " + n3.data + " ) is " + x.data);
	}
}
